...
class DVpatientOxygenSaturation extends StatefulWidget {
      final String patientId;

  const DVpatientOxygenSaturation({super.key,required this.patientId});

  @override
  State<DVpatientOxygenSaturation> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<DVpatientOxygenSaturation> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SfCartesianChart(
        title: ChartTitle(text: 'Oxygen Saturation(Last 15 records)'),
