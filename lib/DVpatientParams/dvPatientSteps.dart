...
class DVpatientSteps extends StatefulWidget {
        final String patientId;

  const DVpatientSteps({super.key, required this.patientId});

  @override
  State<DVpatientSteps> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<DVpatientSteps> {
