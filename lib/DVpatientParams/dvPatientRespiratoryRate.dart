...
class DVpatientRespiratoryRate extends StatefulWidget {
    final String patientId;

  const DVpatientRespiratoryRate({super.key, required this.patientId});

  @override
  State<DVpatientRespiratoryRate> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<DVpatientRespiratoryRate> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SfCartesianChart(
        title: ChartTitle(text: 'Respiratory Rate Values(Last 15 records)'),
